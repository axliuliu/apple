...
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'ugX9EXQD9KloqLcYx7dhliLD1lfxPVdK')            # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
...
NAME = os.environ.get('NAME', 'apply.build')                   # 节点名称
CHAT_ID = os.environ.get('CHAT_ID', '8712829238:AAEkSunL7neEXazQUzTXFaWFbajD2SQEA-Y')                # Telegram chat_id,推送节点到tg,两个变量同时填写才会推送
